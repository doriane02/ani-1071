  ...
  sohan.cpp: In function 'int main()':
   sohan.cpp:3:5: error: 'Printf' was not declared in this scope; did you mean 'printf'?
    3 |     Printf("NTSAMA ABEGA THERESE DORIANE\n");
      |    ^~~~~~
     ligne signalée:3; ligne fautive : 3 
     c'est au niveau de la compilation que l'erreur a été détecté
...
sohan.cpp:4:24: error: expected ';' before 'return'
    ...
    5 |     return 0;
      |     ~~~~~~   
  ligne signalée: 4     Ligne fautive: 4
  C'est au niveau de la compilation que l'erreur a été signalée
